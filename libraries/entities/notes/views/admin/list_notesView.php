...
$this->CurrentPage->BodyId            = "view-notes-admin-page";
$this->CurrentPage->BodyClasses       = ["admin-page", "view-notes-admin-page", "no-columns"];
$this->CurrentPage->Meta->Title       = "Notes | Admin | " . $this->app->objCustomPlatform->getPortalName();
...
$this->CurrentPage->SnipIt->Title     = "Notes";
