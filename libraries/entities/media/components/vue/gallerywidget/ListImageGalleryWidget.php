...
class ListImageGalleryWidget extends VueComponentEntityList
{
    protected string $id = "66a1ea79-5a07-4d79-b58b-955f190f7a1f";
    protected string $modalWidth = "850";
    protected string $title = "Image List";
    protected string $batchLoadEndpoint = "api/v1/media/get-image-batches";
    protected string $noEntitiesWarning = "There are no images to display.";
    ...
    public function __construct($defaultEntity = null, array $components = [])
    {
        ...
        $this->modalTitleForAddEntity = "View Images";
        $this->modalTitleForEditEntity = "View Images";
        $this->modalTitleForDeleteEntity = "View Images";
        $this->modalTitleForRowEntity = "View Images";
    ...
    protected function renderComponentHydrationScript() : string
    {
        return parent::renderComponentHydrationScript() . '
            ...
            this.label = props.label ? props.label : "content-builder"
            this.type = props.type ? props.type : "image"
            this.imageSaveCallback = props.imageSaveCallback ? props.imageSaveCallback : null
            this.screen = \'select-image\';
        ';
    }
        ...
        return parent::renderComponentMethods() . '
            goToImageDashboard: function(entity) {
                ...
                if (typeof this.filterEntity === "undefined") { 
                    ...
                    '. $this->activateRegisteredComponentById(
                        $this->getManageEntityStaticId(),
                        "edit",
                        true,
                        "entity",
                        "this.mainEntityList",
                        [
                            ...
                            "manageType" => "'image'",
                            "editExisting" => "false",
                            "imageSaveCallback" => "this.imageSaveCallback"
                        ],
                        "this",
                        "function() { 
                    ...
                    '.$this->activateRegisteredComponentByIdInModal(
                        $this->getManageEntityStaticId(),
                        "edit",
                        true,
                        "entity",
            ...
            editGradient: function() {
                const self = this
                this.screen = \'select-gradient\'
                const gp = new Grapick({el: "#gradient-picker"});
            ...
            loadGradientToolJs: function() {
                let headTag = document.querySelectorAll("head")[0];
                let floatShieldNode = createNode("script", ["src=/widgets/js/tools/gradient-tool.min.js","#gradient-tool-js"]);
                appendToNode(headTag, floatShieldNode);
            },
            loadGradientToolCss: function() {
                let headTag = document.querySelectorAll("head")[0];
                let floatShieldNode = createNode("link", ["href=/widgets/js/tools/gradient-tool.min.css","#gradient-tool-css","rel=stylesheet"]);
                appendToNode(headTag, floatShieldNode);
            },
            clearImage: function() {
                this.screen = \'empty\'
            ...
            getParentCustomActionX: function() {
                if (this.entityProfile === true && (this.screen == \'select-image\' || this.screen == \'select-color\')) {
                    return true
                }
                return false
            },
            parentCustomActionX: function() {
                if (this.getParentCustomAction()) {
                    this.screen = \'profile\'
                }
                this.$forceUpdate()
            },
            ...
            submitNewImageUpload: function(event) {
                ...
                const url = "api/v1/media/batch-image-upload?uuid=" + this.userId + "&entity_name=" + type + "&entity_id=" + this.entity.card_id + "&user_id=" + this.entity.card_owner_id + "&class=" + this.type;
            ...
            getImageProfileUrl(site) {
                if (site.Media && site.Media[this._props.label]) {
                    return imageServerUrl() + site.Media[this._props.label]
                }
    ...
    protected function renderTemplate() : string
    {
        ...
        return '<div class="formwrapper-control list-images-main-wrapper">
            ...
            .'
                        ...
                        .list-images-main-wrapper .upload-new-image {
                            position: absolute;
                            top: -48px;
                            left: 152px;
                        }
                    ...
                    <div v-show="screen == \'select-image\'">
                        <button class="btn btn-primary upload-new-image" v-bind:class="" v-on:click="openUploadDialog()">Upload New Image</button>
