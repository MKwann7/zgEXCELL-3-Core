...
$this->CurrentPage->BodyId            = "view-tickets-admin-page";
$this->CurrentPage->BodyClasses       = ["admin-page", "view-notes-admin-page", "no-columns"];
$this->CurrentPage->Meta->Title       = "Tickets | Admin | " . $this->app->objCustomPlatform->getPortalName();
...
$this->CurrentPage->SnipIt->Title     = "Tickets";
