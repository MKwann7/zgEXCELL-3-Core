...
$this->CurrentPage->BodyId            = "view-my-tickets-page";
$this->CurrentPage->BodyClasses       = ["view-my-tickets-page", "no-columns"];
$this->CurrentPage->Meta->Title       = "My Tickets | " . $this->app->objCustomPlatform->getPortalName();
...
$this->CurrentPage->SnipIt->Title     = "My Tickets";
