...
class ListPersonasWidget extends VueComponentEntityList
{
    protected string $id = "8d0cbe1f-9a6b-4a9d-96ed-c41b55913a70";
    protected string $title = "Personas";
    protected $singleEntityName = "Persona";
    protected string $batchLoadEndpoint = "users/user-data/get-persona-batches";
    ...
    {
        return new ManagePersonaWidget();
    }

    protected function getManageEntityStaticId() : string
    {
        return ManagePersonaWidget::getStaticId();
    }
