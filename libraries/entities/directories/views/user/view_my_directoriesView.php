...
$this->CurrentPage->BodyId            = "view-my-directories-page";
$this->CurrentPage->BodyClasses       = ["admin-page", "view-my-directories-page", "two-columns", "left-side-column"];
$this->CurrentPage->Meta->Title       = "My Directories | " . $this->app->objCustomPlatform->getPortalName();
...
$this->CurrentPage->SnipIt->Title     = "My Directories";
