...
<div id="<?php echo $directoryId; ?>" class="ezcard-visualization-cards">
    ...
    <div class="cards-options-outer">
        <div class="cards-options">
            <div class="sign-in-to-ez-digital-<?php echo $directoryId; ?>"><span class="pointer addNewEntityButton"></span> Add Me To This Directory!</div>
    ...
    <div class="cards-options-outer">
        <div class="cards-options-body">
            <div class="cards-options-add-record" style="display: none;padding:0 15px;">
                <h4 style="margin-top: 15px; font-size: 19px;text-align:center;">Request Directory Membership</h4>
                <div style="text-align:center;margin-bottom: 15px;">Create your <?php echo $customPlatformName; ?> Account</div>
                <input class="form-control first-name-<?php echo $directoryId; ?>" name="first_name" type="email" placeholder="First Name" value=""><br>
                <input class="form-control last-name-<?php echo $directoryId; ?>" name="last_name" type="email" placeholder="Last Name" value=""><br>
                <input class="form-control email-<?php echo $directoryId; ?>" name="email" type="email" placeholder="Email" value=""><br>
                <input class="form-control phone-<?php echo $directoryId; ?>" name="phone" type="email" placeholder="Mobile Phone" value=""><br>
                ...
                <div style="text-align:center;margin-bottom: 25px;">
                    <a class="pointer sign-in-to-ez-digital-<?php echo $directoryId; ?>" style="text-decoration: underline;">Back to Sign In</a>
                </div>
                <div style="text-align:center;margin-top: 5px;margin-bottom: 15px;font-weight: bold">Optional message for consideration</div>
                <textarea class="form-control message-1-<?php echo $directoryId; ?>" name="msg" id="msg" cols="32" rows="2" maxlength="64" placeholder=""></textarea><br>
                <div class="errors-1-<?php echo $directoryId; ?>"></div>
                <button class="btn ajax-submit-button submitSendEmail" type="submit" name="submitSendEmail1" id="submitSendEmail1-<?php echo $directoryId; ?>" style="width:100%;background-color: #36498f;color:#fff;">Sign-Up/Register</button>
            </div>
            <div class="cards-options-add-record-error" style="display: none;">
                ...
                <div class="error-message-text">Unfortunately, there was an error registering you for this directory.<br><br><div class="cards-options-add-record-error-text"></div><br><br><b>We apologies for the inconvenience.</b></div>
            ...
            <div class="cards-options-add-record-success" style="display: none;">
                <h4 style="margin-top: 15px; font-size: 19px;">Request Directory Membership</h4>
                <div><b>SUCCESS!</b><br><br><b>We've created your <?php echo $customPlatformName; ?> account, registered you for this directory and notified the owner. They will review your submission soon.</b></div>
                <div style="text-align:center;margin: 15px 0 15px;"><a class="pointer close-parent-dialog" data-parent="cards-options-add-record-success" style="text-decoration: underline;">Continue!</a></div>
            </div>
...
<script type="text/javascript">
    ...
    if (typeof ezCardMember<?php echo buildControllerClassFromUri($directoryId); ?> !== "function")
    {
        ezCardMember<?php echo buildControllerClassFromUri($directoryId); ?> = function()
        {
            ...
            const toggleSignInToEzDigital = function(event)
            {
                clearErrors();
                el.getElementsByClassName("cards-options-add-record")[0].style.display = "none";
                el.getElementsByClassName("cards-options-filter")[0].style.display = "none";
            ...
            const createEzDigitalAccount = function(event)
            {
                clearErrors();
            ...
            const submitNewEzDigitalAccount = function(event)
            {
                ...
                sendAjax("/api/v1/directories/public-full-page/create-user-account", entityData, function (result)
                {
                    if (result.success == false)
                    {
                        closeFloatShield();
            ...
            const formValidation = function(entity, validation)
            {
                ...
                for (let currValidationField in  Array.from(validation))
                {
                    if(entity[currValidationField])
                    {
                    ...
                    if (currRule.includes(":"))
                    {
                        ...
                        switch (conditionalRule[0])
                        {
                            case "sameAs":
                                ...
                                {
                                    return validationObject(false, validationField, entityField, ucWords(validationField) + " needs to match " + ucWords(conditionalRule[1]) + ".");
                                }
                                break;
                        }
                    }
                    else
                    {
                        switch(currRule)
                        {
                            case "required":
                                ...
                                {
                                    return validationObject(false, validationField, entityField, ucWords(validationField) + " cannot be blank.");
                                }
                                break;
                            case "passwordComplex":
                                if (!isComplexPassword(entityField.value))
                                {
                                    return validationObject(false, validationField, entityField, ucWords(validationField) + " isn't complex enough.");
                                }
                                break;
                            case "email":
                                if (!isEmail(entityField.value))
                                {
                                    return validationObject(false, validationField, entityField, ucWords(validationField) + " isn't an email address.");
                                }
                                break;
                        }
                    }
            ...
            this.load = function(id)
            {
                ...
                classList("sign-in-to-ez-digital-<?php echo $directoryId; ?>", function(elm) {
                    elm.addEventListener(touchEvent, function(event){ toggleSignInToEzDigital(event); });
                });
                ...
                classList("add-record-request-<?php echo $directoryId; ?>", function (elm) {
                    elm.addEventListener(touchEvent, function(event){ toggleAddRecordRequest(event); });
                });
                classList("create-ez-digital-account", function (elm) {
                    elm.addEventListener(touchEvent, function(event){ createEzDigitalAccount(event); });
                });
