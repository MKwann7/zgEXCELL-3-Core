...
use Entities\Packages\Components\Vue\PackageMainApp;
...
$pageRequest = array_slice($this->app->objHttpRequest->Uri, 4);
$this->VueApp = new PackageMainApp("vueApp", $this->Modal, $pageRequest);
