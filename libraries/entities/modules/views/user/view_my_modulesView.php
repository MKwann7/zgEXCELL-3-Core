...
$this->CurrentPage->BodyId            = "view-my-modules-admin-page";
$this->CurrentPage->BodyClasses       = ["admin-page", "view-my-modules-admin-page", "no-columns"];
$this->CurrentPage->Meta->Title       = "My Modules | " . $this->app->objCustomPlatform->getPortalName();
...
$this->CurrentPage->SnipIt->Title     = "My Modules";
