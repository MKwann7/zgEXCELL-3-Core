...
$this->CurrentPage->BodyId            = "view-my-products-page";
$this->CurrentPage->BodyClasses       = ["admin-page", "view-my-products-page", "two-columns", "left-side-column"];
$this->CurrentPage->Meta->Title       = "My Proudcts | " . $this->app->objCustomPlatform->getPortalName();
