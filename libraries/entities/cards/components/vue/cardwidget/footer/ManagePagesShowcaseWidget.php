...
class ManagePagesShowcaseWidget extends VueComponent
{
    protected string $id = "74387fc2-9713-431d-ba35-947ec6ec6ed0";
    ...
    public function __construct (array $components = [])
    {
        ...
        $this->modalTitleForAddEntity = "Edit Showcase Pages";
    ...
    protected function renderTemplate() : string
    {
        ...
        <div class="editEntityProfile site-theme-settings">
            ...
            <button v-on:click="updateShowcasePage" class="buttonID9234594357456 btn btn-primary w-100">Update Showcase Pages</button>
        </div>';
    }
