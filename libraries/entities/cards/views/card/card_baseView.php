...
<head>
    ...
    <link rel="stylesheet" href="/app/css/template.min.css?version=<?php echo env("CSS_VERSION_APPTEMPLATE"); ?>&_=<?php echo rand(100,99); ?>" />
    <script src="https://www.gstatic.com/charts/loader.js"></script>
    <script src="/app/js/template.min.js?version=<?php echo env("JS_VERSION_APPTEMPLATE"); ?>&_=<?php echo rand(100,99); ?>"></script>
</head>
