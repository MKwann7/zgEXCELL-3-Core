...
$this->CurrentPage->BodyId            = "view-max-groups-page";
$this->CurrentPage->BodyClasses       = ["admin-page", "view-max-groups-page", "two-columns", "left-side-column"];
$this->CurrentPage->Meta->Title       = "Max Groups | " . $this->app->objCustomPlatform->getPortalName();
...
$this->CurrentPage->SnipIt->Title     = "Max Groups";
